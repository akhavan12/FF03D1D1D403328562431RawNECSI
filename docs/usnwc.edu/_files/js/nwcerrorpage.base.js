                    ...
                    function (t) {
                        r =
                            (e.getComputedStyle
                                ...
                                : t.currentStyle)["position"] == "absolute";
                    }
                ),
                r
            );
...
(function ($) {
    $.fn.gMap = function (options, methods_options) {
        ...
        return this.each(function () {
            ...
            if (opts.address) {
                ...
                if (opts.latitude && opts.longitude) {
                    ...
                    if ($.isArray(opts.markers) && opts.markers.length > 0) {
                        ...
                        $gmap.setCenter(
                            new google.maps.LatLng(34.885931, 9.84375)
                        );
                    }
                }
            }
            ...
            $(this).bind(
                "gMap.centerAt",
                function (e, latitude, longitude, zoom) {
                    if (zoom) {
                        $gmap.setZoom(zoom);
                    }
                    $gmap.panTo(
                ...
                function (e, latitude, longitude, content, icon, popup) {
                    ...
                    if (content) {
                        ...
                        var infowindow = new google.maps.InfoWindow({
                            content:
                                opts.html_prepend + content + opts.html_append,
                        });
        ...
        smoothScroll: function () {
            ...
            function init() {
                ...
                if (document.URL.indexOf("mail.google.com") > -1) {
                    ...
                    (
                        document.getElementsByTagName("head")[0] || html
                    ).appendChild(s);
                } else if (document.URL.indexOf("www.facebook.com") > -1) {
                    var home_stream = document.getElementById("home_stream");
                    home_stream &&
                        (home_stream.style.webkitTransform = "translateZ(0)");
                }
            ...
            function keydown(event) {
                ...
                switch (event.keyCode) {
                    ...
                    case key.end:
                        var damt =
                            elem.scrollHeight - elem.scrollTop - clientHeight;
                        y = damt > 0 ? damt + 10 : 0;
                        break;
                    case key.left:
            ...
            function overflowingAncestor(el) {
                ...
                do {
                    ...
                    if (rootScrollHeight === el.scrollHeight) {
                        if (
                            !isFrame ||
                            root.clientHeight + 10 < rootScrollHeight
                        ) {
...
(function ($) {
    ...
    matchHeight._applyDataApi = function () {
        ...
        $("[data-match-height], [data-mh]").each(function () {
            var $this = $(this),
                groupId =
                    $this.attr("data-match-height") || $this.attr("data-mh");
                        ...
                        .each(function (c) {
                            ...
                            b.options.showElement(n),
                                ...
                                b.particles.push({
                                    ...
                                    parentOffsetTop: p,
                                    stellarRatio:
                                        n.data("stellar-ratio") !== d
                                            ? n.data("stellar-ratio")
                                            : 1,
...
!(function (root, factory) {
    ...
    Vide.prototype.init = function () {
        ...
        if (vide.settings.posterType === "detect") {
            ...
            vide.$wrapper.css(
                "background-image",
                "url(" + poster + "." + vide.settings.posterType + ")"
            );
        }
        ...
        if (typeof vide.path === "object") {
            if (vide.path.mp4) {
                sources +=
                    '<source src="' + vide.path.mp4 + '.mp4" type="video/mp4">';
            }
            if (vide.path.webm) {
                sources +=
                    '<source src="' +
            ...
            if (vide.path.ogv) {
                sources +=
                    '<source src="' + vide.path.ogv + '.ogv" type="video/ogv">';
            }
    ...
    Vide.prototype.resize = function () {
        ...
        if (wrapperWidth / videoWidth > wrapperHeight / videoHeight) {
            this.$video.css({ width: wrapperWidth + 2, height: "auto" });
        } else {
    ...
    $.fn.jflickrfeed = function (settings, callback) {
        settings = $.extend(
            true,
            {
                ...
                useTemplate: true,
                itemTemplate:
                    '<li><a href="{{image_b}}" title="{{title}}"><span class="thumbnail"><img src="{{image_s}}" /></span></a></li>',
...
(function ($, window, undefined) {
    ...
    $.Flipshow.defaults = { speed: 700, easing: "ease-out" };
    $.Flipshow.prototype = {
        _init: function (options) {
            ...
            if (this.support) {
                this.transEndEventName =
                    ...
                    ".cbpFWSlider";
                this.transformName =
                    transformNames[Modernizr.prefixed("transform")];
            }
        ...
        if (typeof options === "string") {
            ...
            this.each(function () {
                ...
                if (
                    ...
                    logError(
                        "no such method '" + options + "' for flipshow instance"
                    );
                    return;
                }
